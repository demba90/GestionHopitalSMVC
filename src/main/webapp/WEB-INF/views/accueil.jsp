...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<%=request.getContextPath()%>/resources/assets/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    ...
    <!-- Template js -->
    <script src="<%=request.getContextPath()%>/resources/assets/js/jquery-2.1.1.min.js"></script>
    <script src="<%=request.getContextPath()%>/resources/assets/bootstrap/js/bootstrap.min.js"></script>
    <script src="<%=request.getContextPath()%>/resources/assets/js/jquery.appear.js"></script>
    <script src="<%=request.getContextPath()%>/resources/assets/js/contact_me.js"></script>
    <script src="<%=request.getContextPath()%>/resources/assets/js/jqBootstrapValidation.js"></script>
    <script src="<%=request.getContextPath()%>/resources/assets/js/modernizr.custom.js"></script>
    <script src="<%=request.getContextPath()%>/resources/assets/js/script.js"></script>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
                            ...
                            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="padding-bottom: 30px;">
                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <img src="<%=request.getContextPath()%>/resources/assets/images/about-03.jpg" class="img-responsive" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="<%=request.getContextPath()%>/resources/assets/images/about-02.jpg" class="img-responsive" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="<%=request.getContextPath()%>/resources/assets/images/about-01.jpg" class="img-responsive" alt="">
                                    </div>
        ...
        <div class="copyright text-center">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div>Par <a href="#" target="_blank">demba90</a> & <a href="#">darcia</a></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/portfolio/1.png" class="img-responsive" alt="...">
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/portfolio/2.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/portfolio/3.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/portfolio/4.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/portfolio/5.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/portfolio/6.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/portfolio/7.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/portfolio/8.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/portfolio/9.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/portfolio/10.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/portfolio/11.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="portfolio-item">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/portfolio/12.png" class="img-responsive" alt="...">
                                <div class="portfolio-details text-center">
                                    <h4>Project Name</h4>
                                    <a href="#"><i class="fa fa-link"></i></a>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/team/manage-1.png" class="img-responsive" alt="">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/team/manage-2.png" class="img-responsive" alt="">
                                <div class="team-details">
                                    <h4>John Doe</h4>
                                    <div class="designation">Senior Web Developer</div>
                                    <ul style="text-align: center;">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/team/manage-3.png" class="img-responsive" alt="">
                                <div class="team-details">
                                    <h4>John Doe</h4>
                                    <div class="designation">Senior Web Developer</div>
                                    <ul style="text-align: center;">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/team/manage-4.png" class="img-responsive" alt="">
                                <div class="team-details">
                                    <h4>John Doe</h4>
                                    <div class="designation">Senior Web Developer</div>
                                    <ul style="text-align: center;">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/team/team-1.jpg" class="img-responsive" alt="">
                                <div class="team-details">
                                    <h4>John Doe</h4>
                                    <div class="designation">Senior Web Developer</div>
                                    <ul style="text-align: center;">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/team/team-2.jpg" class="img-responsive" alt="">
                                <div class="team-details">
                                    <h4>John Doe</h4>
                                    <div class="designation">Senior Web Developer</div>
                                    <ul style="text-align: center;">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/team/team-3.jpg" class="img-responsive" alt="">
                                <div class="team-details">
                                    <h4>John Doe</h4>
                                    <div class="designation">Senior Web Developer</div>
                                    <ul style="text-align: center;">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="team-member">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/team/team-4.jpg" class="img-responsive" alt="">
                                <div class="team-details">
                                    <h4>John Doe</h4>
                                    <div class="designation">Senior Web Developer</div>
                                    <ul style="text-align: center;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="latest-post">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/blog-01.jpg" class="img-responsive" alt="">
                        ...
                        <div class="col-md-6">
                            <div class="latest-post">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/blog-02.jpg" class="img-responsive" alt="">
                                <h4><a href="#">Standard Post with Image</a></h4>
                                <div class="post-details">
                                    <ul>
                                        <li><i class="fa fa-user"></i> Auther : iThemesLab</li>
                        ...
                        <div class="col-md-6">
                            <div class="latest-post">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/blog-03.jpg" class="img-responsive" alt="">
                                <h4><a href="#">Standard Post with Image</a></h4>
                                <div class="post-details">
                                    <ul>
                                        <li><i class="fa fa-user"></i> Auther : iThemesLab</li>
                        ...
                        <div class="col-md-6">
                            <div class="latest-post">
                                <img src="<%=request.getContextPath()%>/resources/assets/images/blog-04.jpg" class="img-responsive" alt="">
                                <h4><a href="#">Standard Post with Image</a></h4>
                                <div class="post-details">
                                    <ul>
                                        <li><i class="fa fa-user"></i> Auther : iThemesLab</li>
